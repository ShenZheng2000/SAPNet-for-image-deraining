# Purpose: to combine Attention, Canny, URSA (if attention not work, then use Canny + URSA)
...
from Modeling.network_tmp.networks5 import *
...
parser.add_argument("--save_path", type=str, default="logs/PReNet_test/Model5", help='path to save models and log files')
parser.add_argument("--save_freq", type=int, default=1, help='save intermediate model')
parser.add_argument("--data_path", type=str, default="datasets/train/RainTrainH", help='path to training data')
parser.add_argument("--use_gpu", type=bool, default=True, help='use GPU or not')  # Set True for GPU training
