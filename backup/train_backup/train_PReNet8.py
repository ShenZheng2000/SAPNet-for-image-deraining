# Purpose: to combine URSS, Canny and channel attention with skip connections
...
parser.add_argument("--save_path", type=str, default="logs/PReNet_test/Model8", help='path to save models and log files')
