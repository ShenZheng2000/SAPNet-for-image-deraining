# Purpose: to introduce Unsupervised Rain Streak Segmentation
...
from Modeling.network_tmp.networks3 import *
...
parser.add_argument("--save_path", type=str, default="logs/PReNet_test/Model3", help='path to save models and log files')
