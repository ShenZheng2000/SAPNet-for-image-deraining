# Purpose: to introduce Canny or Laplacian Edge loss
...
from Modeling.network_tmp.networks4 import *
...
parser.add_argument("--save_path", type=str, default="logs/PReNet_test/Model4", help='path to save models and log files')
