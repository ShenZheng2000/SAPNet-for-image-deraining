# Purpose: to combine URSS, Canny and S.E. blocks
...
from Modeling.network_tmp.networks6 import *
...
parser.add_argument("--save_path", type=str, default="logs/PReNet_test/Model6", help='path to save models and log files')
