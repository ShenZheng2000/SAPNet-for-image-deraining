# Purpose: to introduce Visual Attention (and to change the network structure)
...
from Modeling.network_tmp.networks2 import *
...
parser.add_argument("--save_path", type=str, default="logs/PReNet_test/Model2", help='path to save models and log files')
parser.add_argument("--save_freq",type=int,default=1,help='save intermediate model')
parser.add_argument("--data_path",type=str, default="datasets/train/RainTrainH",help='path to training data') # Default is Rain12600
...
def main():
    ...
    if initial_epoch > 0:
        ...
        model.load_state_dict(torch.load(os.path.join(opt.save_path, 'net_epoch%d.pth' % initial_epoch),map_location='cpu'))
