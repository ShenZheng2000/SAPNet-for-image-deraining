...
# keep this file in mind D:/Code/SOTA/Ref_Data/test12/groundtruth/
import os
import numpy as np
import math
import cv2
...
# First check Rain 100H, then check Rain 100L, Rain 12 and Rain 1400
path1 = 'D:/Code/SOTA/Ref_Data/test12/rainy/'  # 指定输出结果文件夹
path2 = 'D:/Code/SOTA/Ref_Data/test12/groundtruth/'  # 指定原图文件夹
